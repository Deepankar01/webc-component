...
type IframeEventType = "det_pay:load"| "det_pay:error"| "det_pay:ready" | "det_pay:height" | "det_pay:result";
type EventType = ConfigurationFetchEventType | IframeEventType;
...
type DETPayMessage =
  ...
  | { type: "det_pay:error";  payload: { code: string; message: string | object } }
